...
public partial class PhongKhamOnlineContext : DbContext
{
    public PhongKhamOnlineContext()
    {
    }

    public PhongKhamOnlineContext(DbContextOptions<PhongKhamOnlineContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BenhAn>(entity =>
        {
            ...
            entity.Property(e => e.MaBenhAn).HasMaxLength(10);
            ...
            entity.Property(e => e.MaBn).HasMaxLength(10);
            entity.Property(e => e.MaBs).HasMaxLength(10);
            entity.Property(e => e.MaKham).HasMaxLength(10);
        ...
        modelBuilder.Entity<TaiKhoanBenhNhan>(entity =>
        {
            ...
            entity.Property(e => e.HoTenBn).HasMaxLength(255);
            entity.Property(e => e.MaBn)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength();
